...
class DecisionsControllerTest < ActionController::TestCase
  ...
  test "should create decision" do
    assert_difference('Decision.count') do
      post :create, decision: { decided_id: @decision.decided_id, decider_id: @decision.decider_id, like: @decision.like }
    end
  ...
  test "should update decision" do
    patch :update, id: @decision, decision: { decided_id: @decision.decided_id, decider_id: @decision.decider_id, like: @decision.like }
    assert_redirected_to decision_path(assigns(:decision))
  end
